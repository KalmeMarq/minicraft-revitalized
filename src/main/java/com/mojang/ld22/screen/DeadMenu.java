...
public class DeadMenu extends Menu {
	...
	public void render(Screen screen) {
		...
		Font.draw(Translation.translate("minicraft.menu.dead"), screen, 2 * 8, 4 * 8, Color.get(-1, 555, 555, 555));
		...
		Font.draw(Translation.translate("minicraft.menu.dead.lose"), screen, 2 * 8, 8 * 8, Color.get(-1, 333, 333, 333));
	}
}
